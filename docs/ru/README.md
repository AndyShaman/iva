...
- [reminders.md](reminders.md) - как попросить Иву напомнить: разовое и повторяющееся, дословный режим и режим с ходом, минутный диспетчер, что бывает при сбое доставки
