...
export default defineTool({
  description:
    "Показать поставленные напоминания: id, текст, режим, следующий срок next_run_at в зоне " +
    "пользователя, статус последней доставки. Время не пересчитывай, показывай как вернул инструмент. " +
