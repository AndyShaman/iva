...
// Усыновление не теряет живой awaitText: иначе следующий секрет прошёл бы мимо
// перехвата (не удалён из чата, ушёл в eve).
await test("F-MENU: усыновление сохраняет живой awaitText", async () => {
